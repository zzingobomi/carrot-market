          ...
          <div className="fixed py-2 bg-white bottom-0 inset-x-0">
            ...
            >
              <input
                ...
                className="shadow-sm rounded-full w-full h-10 px-4 border border-gray-300 focus:border focus:ring-orange-500 focus:outline-none pr-12 focus:border-orange-500"
              />
